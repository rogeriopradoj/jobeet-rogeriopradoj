...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en">
  <head>
    <base href="<?php echo $sf_request->getRelativeUrlRoot(); ?>" />
    <title>
  ...
  <body>
    <div id="container">
      ...
      <div id="footer">
        <div class="content">
          <span class="symfony">
            <img src="<?php echo $sf_request->getRelativeUrlRoot(); ?>/images/jobeet-mini.png" />
            powered by <a href="http://www.symfony-project.org/">
            <img src="<?php echo $sf_request->getRelativeUrlRoot(); ?>/images/symfony.gif" alt="symfony framework" />
            </a>
          </span>
          <ul>
